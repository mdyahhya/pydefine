...
EXCEPTION_MAP = {
    ...
    "DeprecationWarning": {
        "simple_explanation": (
            "You're using a feature that will be removed in future Python versions. "
            "The code works now but won't work later. "
            "Feature is deprecated ⚠️"
        ),
        "fix_suggestion": (
            "Check documentation for the replacement feature. "
            "Update code to use the new recommended method"
        ),
        "tags": ["warning", "deprecation", "future", "compatibility"],
        "emoji": "⚠️"
    },
    
    "UserWarning": {
        "simple_explanation": (
            "A warning issued by user code (via warnings.warn()). "
            "The program detected something unusual but continued. "
            "User-defined warning ⚠️"
        ),
        "fix_suggestion": (
            "Read the warning message for context. "
            "Check the code that issued the warning"
        ),
        "tags": ["warning", "user", "custom", "notice"],
        "emoji": "⚠️"
    },
    
    "FutureWarning": {
        "simple_explanation": (
            "Code behavior will change in future versions. "
            "This warns about changes that will affect you later. "
            "Future behavior change ⚠️"
        ),
        "fix_suggestion": (
            "Read the warning and update code to match future behavior. "
            "Check documentation for migration guide"
        ),
        "tags": ["warning", "future", "change", "compatibility"],
        "emoji": "⚠️"
    },
    
    "SyntaxWarning": {
        "simple_explanation": (
            "Python noticed suspicious syntax that might be a mistake. "
            "The code runs but looks wrong. "
            "Suspicious syntax ⚠️"
        ),
        "fix_suggestion": (
            "Review the flagged syntax. "
            "Make sure your code does what you intend"
        ),
        "tags": ["warning", "syntax", "suspicious", "potential-error"],
        "emoji": "⚠️"
    },
    
    "RuntimeWarning": {
        "simple_explanation": (
            "A warning about suspicious runtime behavior. "
            "Something looks wrong during execution. "
            "Runtime warning ⚠️"
        ),
        "fix_suggestion": (
            "Investigate the warning message. "
            "Check for logic errors or unexpected behavior"
        ),
        "tags": ["warning", "runtime", "behavior", "suspicious"],
        "emoji": "⚠️"
    },
    
    "ResourceWarning": {
        "simple_explanation": (
            "A resource (file, socket) wasn't properly closed. "
            "You have a resource leak. "
            "Resource not closed ⚠️"
        ),
        "fix_suggestion": (
            "Use 'with' statements for files and connections. "
            "Explicitly close resources when done"
        ),
        "tags": ["warning", "resource", "leak", "cleanup"],
        "emoji": "⚠️"
    },
